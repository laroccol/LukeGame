...
#include "LukeGameWeapon.generated.h"

class UAnimMontage;
class ALukeGameCharacter;
...
UCLASS()
class LUKEGAME_API ALukeGameWeapon : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	ALukeGameWeapon(const FObjectInitializer& ObjectInitializer);
	...
	virtual void OnEquip(const ALukeGameWeapon* LastWeapon);
	...
	virtual void OnEnterInventory(ALukeGameCharacter* NewOwner);
	...
	UFUNCTION(BlueprintCallable, Category = "Game|Weapon")
		class ALukeGameCharacter* GetPawnOwner() const;
	...
	void SetOwningPawn(ALukeGameCharacter* ALukeGameCharacter);
	...
	int GetConcurrentShotsFired();

	void SetConcurrentShotsFired(int InShotsFired);

protected:

	/** pawn owner */
	UPROPERTY(Transient, ReplicatedUsing = OnRep_MyPawn)
		class ALukeGameCharacter* MyPawn;

	/** weapon data */
	UPROPERTY(EditDefaultsOnly, Category = Config)
		FWeaponData WeaponConfig;

	int ConcurrentShotsFired;
