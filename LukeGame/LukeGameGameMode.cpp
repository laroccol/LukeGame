...
ALukeGameGameMode::ALukeGameGameMode()
	: Super()
{
	...
	static ConstructorHelpers::FClassFinder<APlayerController> PlayerControllerBPClass(TEXT("/Game/ThirdPersonCPP/Blueprints/BP_LukeGamePlayerController"));
	if (PlayerControllerBPClass.Class != NULL)
	{
		PlayerControllerClass = PlayerControllerBPClass.Class;
	}

	HUDClass = ALukeGameHUD::StaticClass();
...
bool ALukeGameGameMode::CanDealDamage(class ALukeGamePlayerState* DamageInstigator, class ALukeGamePlayerState* DamagedPlayer) const
{
	return true;
}
