...
ALukeGameExplosionEffect::ALukeGameExplosionEffect(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
void ALukeGameExplosionEffect::BeginPlay()
{
	Super::BeginPlay();
...
void ALukeGameExplosionEffect::Tick(float DeltaSeconds)
{
