...
#include "LukeGameProjectile.generated.h"

class UProjectileMovementComponent;
class USphereComponent;

UCLASS(Abstract, Blueprintable)
class LUKEGAME_API ALukeGameProjectile : public AActor
{
	GENERATED_BODY()

public:

	ALukeGameProjectile(const FObjectInitializer& ObjectInitializer);
