 ...
 */
UCLASS()
class LUKEGAME_API ALukeCar : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY()
		ALukeGameCharacter* OwningCharacter;
...
public:
	...
	void EnterCharacter(ALukeGameCharacter* Character);
